<template>
    <v-layout row justify-center>
        <v-dialog v-model="modalone" persistent max-width="600px">
            <v-card>
                <v-card-title>
                    <span class="headline">Create an Incident</span>
                </v-card-title>
                <v-card-text>
                ...
                <v-card-actions>
                    ...
                    <v-btn color="blue darken-1" flat @click="toggleModal">Save</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
    </v-layout>
...
<script>
    export default {
        ...
        methods: {
            toggleModal() {
                this.$eventBus.$emit("close-modal-one", "Hello!");
